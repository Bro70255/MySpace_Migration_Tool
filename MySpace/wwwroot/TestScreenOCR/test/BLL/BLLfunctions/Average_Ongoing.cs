        public static DataTable Average_Ongoing(int firm, int Employee_Code, int UserType)
        {
            try
            {
                using (SqlConnection NewConnection = new SqlConnection(Connection.ConnectionString))
                {
                    ...
                    using (SqlTransaction NewTransation = NewConnection.BeginTransaction())
                    {
                        try
                        {
                            ...
                            DataTable result = CRF_Tracker_dal.Average_Ongoing(NewTransation, firm, Employee_Code, UserType);
