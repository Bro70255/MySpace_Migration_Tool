        public static DataTable Get_Bind_Technicalanalysis_Techlead(int Techlead)
        {
            try
            {
                DataTable dtDetail;
                using (SqlConnection NewConnection = new SqlConnection(Connection.ConnectionString))
                {
                    ...
                    using (SqlTransaction NewTransation = NewConnection.BeginTransaction())
                    {
                        try
                        {
                            dtDetail = CRF_Tracker_dal.Get_Bind_Technicalanalysis_Techlead(NewTransation, Techlead);
