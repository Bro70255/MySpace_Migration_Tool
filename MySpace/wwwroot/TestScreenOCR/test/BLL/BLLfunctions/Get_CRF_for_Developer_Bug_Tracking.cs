        public static DataTable Get_CRF_for_Developer_Bug_Tracking(int EMP_CODE)
        {
            try
            {
                DataTable dtDetail;
                using (SqlConnection NewConnection = new SqlConnection(Connection.ConnectionString))
                {
                    ...
                    using (SqlTransaction NewTransation = NewConnection.BeginTransaction())
                    {
                        try
                        {
                            dtDetail = CRF_Tracker_dal.Get_CRF_for_Developer_Bug_Tracking(NewTransation, EMP_CODE);
