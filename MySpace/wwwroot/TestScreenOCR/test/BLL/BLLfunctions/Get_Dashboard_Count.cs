        public static DataTable Get_Dashboard_Count(int EMP_CODE, int UserID, int FIRM, int UNIT, int Team_id, int UserType)
        {
            try
            {
                DataTable dtDetail;
                using (SqlConnection NewConnection = new SqlConnection(Connection.ConnectionString))
                {
                    ...
                    using (SqlTransaction NewTransation = NewConnection.BeginTransaction())
                    {
                        try
                        {
                            dtDetail = CRF_Tracker_dal.Get_Dashboard_Count(NewTransation, EMP_CODE, UserID, FIRM, UNIT, Team_id, UserType);
