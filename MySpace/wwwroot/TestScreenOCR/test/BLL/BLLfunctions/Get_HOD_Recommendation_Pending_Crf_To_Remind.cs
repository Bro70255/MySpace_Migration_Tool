        public static DataTable Get_HOD_Recommendation_Pending_Crf_To_Remind()
        {
            try
            {
                DataTable dtDetail;
                using (SqlConnection NewConnection = new SqlConnection(Connection.ConnectionString))
                {
                    ...
                    using (SqlTransaction NewTransation = NewConnection.BeginTransaction())
                    {
                        try
                        {
                            dtDetail = CRF_Tracker_dal.Get_HOD_Recommendation_Pending_Crf_To_Remind(NewTransation);
