        public static DataTable Get_Teach_Lead_Team_Details(int EMP_CODE, int Team_id)
        {
            try
            {
                DataTable dtDetail;
                using (SqlConnection NewConnection = new SqlConnection(Connection.ConnectionString))
                {
                    ...
                    using (SqlTransaction NewTransation = NewConnection.BeginTransaction())
                    {
                        try
                        {
                            dtDetail = CRF_Tracker_dal.Get_Teach_Lead_Team_Details(NewTransation, EMP_CODE, Team_id);
