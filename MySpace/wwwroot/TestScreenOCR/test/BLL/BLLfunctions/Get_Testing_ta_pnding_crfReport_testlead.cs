        public static DataTable Get_Testing_ta_pnding_crfReport_testlead(int firm)
        {
            try
            {
                DataTable dtDetail;
                using (SqlConnection NewConnection = new SqlConnection(Connection.ConnectionString))
                {
                    ...
                    using (SqlTransaction NewTransation = NewConnection.BeginTransaction())
                    {
                        try
                        {
                            dtDetail = CRF_Tracker_dal.Get_Testing_ta_pnding_crfReport_testlead(NewTransation, firm);
