        public static DataTable Get_User_Feedback_Report(DateTime Startdate, DateTime Enddate, int firm)
        {
            try
            {
                DataTable dtDetail;
                using (SqlConnection NewConnection = new SqlConnection(Connection.ConnectionString))
                {
                    ...
                    using (SqlTransaction NewTransation = NewConnection.BeginTransaction())
                    {
                        try
                        {
                            dtDetail = CRF_Tracker_dal.Get_User_Feedback_Report(NewTransation, Startdate, Enddate, firm);
