        public static void Save_Bug_Resolved(string Tester_Bug_Report_ID, int bugfix, string remark)
        {
            try
            {
                using (SqlConnection NewConnection = new SqlConnection(Connection.ConnectionString))
                {
                    ...
                    using (SqlTransaction NewTransation = NewConnection.BeginTransaction())
                    {
                        try
                        {
                            ...
                            CRF_Tracker_dal.Save_Bug_Resolved(NewTransation, Tester_Bug_Report_ID, bugfix, remark);
