        public static void Update_hod_recommendation(int HOD, int EMP_CODE, string crf_ID, string Remark)
        {
            try
            {
                ...
                using (SqlConnection NewConnection = new SqlConnection(Connection.ConnectionString))
                {
                    ...
                    using (SqlTransaction NewTransation = NewConnection.BeginTransaction())
                    {
                        try
                        {
                            ...
                            CRF_Tracker_dal.Update_hod_recommendation(NewTransation, HOD, EMP_CODE, crf_ID, Remark);
