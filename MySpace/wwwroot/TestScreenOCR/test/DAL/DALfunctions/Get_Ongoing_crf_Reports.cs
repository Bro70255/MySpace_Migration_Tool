        public static DataTable Get_Ongoing_crf_Reports(SqlTransaction newTransaction, int firm, int Employee_Code, int UserType, int Team_id, int Unit)
        {
            ...
            try
            {
                ...
                SqlHelper.FillDatatable(newTransaction, CommandType.StoredProcedure, StoreProcedure.GET_ONGOING_CRF_REPORTS, dtDetails, 0, parameters);
            }
            catch (Exception ex)
            {
                throw ex;
