        public static DataTable Get_Rejected_crf_Reports(SqlTransaction newTransaction, int firm, int Employee_Code, int UserType, int Team_id, int Unit)
        {
            ...
            try
            {
                ...
                SqlHelper.FillDatatable(newTransaction, CommandType.StoredProcedure, StoreProcedure.GET_REJECTED_CRF_REPORTS, dtDetails, 0, parameters);
            }
            catch (Exception ex)
            {
                throw ex;
