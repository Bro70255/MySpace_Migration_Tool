        public static DataTable Get_Total_live_closed_this_month(SqlTransaction newTransaction, int firm, int Employee_Code, int UserType, int Team_id, int Unit)
        {
            ...
            try
            {
                ...
                SqlHelper.FillDatatable(newTransaction, CommandType.StoredProcedure, StoreProcedure.GET_TOTAL_LIVE_CLOSED_THIS_MONTH, dtDetails, 0, parameters);
            }
            catch (Exception ex)
            {
                throw ex;
