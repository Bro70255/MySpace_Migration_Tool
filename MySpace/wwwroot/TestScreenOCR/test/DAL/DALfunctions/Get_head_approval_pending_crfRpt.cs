        public static DataTable Get_head_approval_pending_crfRpt(SqlTransaction newTransaction, int firm, int Employee_Code, int UserType, int Team_id, int Unit)
        {
            ...
            try
            {
                ...
                SqlHelper.FillDatatable(newTransaction, CommandType.StoredProcedure, StoreProcedure.GET_HEAD_APPROVAL_PENDING_CRFRPT, dtDetails, 0, parameters);
            }
            catch (Exception ex)
            {
                throw ex;
